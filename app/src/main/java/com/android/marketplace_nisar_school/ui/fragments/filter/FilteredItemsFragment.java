package com.android.marketplace_nisar_school.ui.fragments.filter;
...
import com.android.marketplace_nisar_school.adapters.FilteredItemsAdapter;
import com.android.marketplace_nisar_school.data.Item;
import com.android.marketplace_nisar_school.databinding.FragmentFilteredItemsBinding;
                ...
                if (snapshot.exists()) {
                    for (DataSnapshot i : snapshot.getChildren()) {
                        ...
                        if ((item.getCondition().equals(condition))) {
                            ...
                            Timber.d("Condition: Items found");
