package com.android.marketplace_nisar_school.ui.fragments.details;
...
import com.android.marketplace_nisar_school.databinding.FragmentDetailsBinding;
...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.favItemPrice1.setText("AED " + data.getItemPrice());
        ...
        binding.whatsappButton.setOnClickListener(v -> {
            ...
            intent.setData(Uri.parse(url + "&text=" + "Hey, I have seen you are selling " + data.getItemName() + ". Can we finalize the deal?"));
            startActivity(intent);
            Timber.d(phone);
        });
