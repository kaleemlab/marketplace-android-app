package com.android.marketplace_nisar_school.adapters;
...
import com.android.marketplace_nisar_school.ui.fragments.filter.FilteredItemsFragmentDirections;
...
public class FilteredItemsAdapter extends RecyclerView.Adapter<FilteredItemsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.item_price.setText("AED " + items.get(position).getItemPrice());
